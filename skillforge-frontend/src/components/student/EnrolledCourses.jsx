            ...
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900">
                {enrolledCourses.length > 0
                  ? Math.round(enrolledCourses.reduce((sum, c) => sum + (c.enrollment?.progressPercent ??
                    c.enrollment?.completionPercentage ??
                    0), 0) / enrolledCourses.length)
                  : 0}%
              </p>
            </div>
          ...
          {enrolledCourses.map((course) => (
            <Card key={course.id} hover className="overflow-hidden">
              ...
              >
                ...
                <div className="w-full h-full bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center" style={course.thumbnailUrl ? { display: 'none' } : {}}>
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4">
                  <div className="flex items-center justify-between text-white text-sm mb-2">
                    <span>Progress</span>
                    <span>{course.enrollment?.progressPercent ??
                  ...
                  <div className="w-full h-2 bg-gray-700 rounded-full overflow-hidden">
                    <div
                      ...
                      // style={{ width: `${course.enrollment?.completionPercentage || 0}%` }}
                      style={{
